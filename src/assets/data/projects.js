...
const projects = [
  {
    ...
    name: 'Cactus Baby',
    desc:
      'An E-Commerce website for all things Succulents. BABY CACTUS is a simple and user-friendly interface with ability to create an account and save your user history, take payment and have off-line access.',
    img: CactusBabyImg,
  },
  {
    id: uuidv4(),
  ...
  },
  {
    ...
    name: 'High Life',
    desc:
      'I want to move to another city and search for a job in that city and Also have the option to search for houses around that city',
    img: HighLifeImg,
  },
];
